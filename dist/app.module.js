        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    extra: {
                        min: Math.floor((configService.get('database.poolSize') || 20) / 4),
                        max: configService.get('database.poolMaxConnections') || 100,
                        idleTimeoutMillis: configService.get('database.poolIdleTimeout'),
                        acquireTimeoutMillis: configService.get('database.poolAcquireTimeout'),
                        createTimeoutMillis: 30000,
                        validateConnection: configService.get('database.poolValidateConnection'),
