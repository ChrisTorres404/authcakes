...
exports.AddOtpColumnsToUsers1748058940861 = void 0;
class AddOtpColumnsToUsers1748058940861 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP CONSTRAINT "refresh_tokens_sessionId_fkey"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "sessions_userId_fkey"`);
        ...
        await queryRunner.query(`ALTER TABLE "mfa_recovery_codes" DROP CONSTRAINT "FK_mfa_recovery_codes_user"`);
        await queryRunner.query(`ALTER TABLE "webauthn_credentials" DROP CONSTRAINT "FK_webauthn_credentials_user"`);
        await queryRunner.query(`ALTER TABLE "logs" DROP CONSTRAINT "FK_logs_user"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_refresh_tokens_isRevoked"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_mfa_recovery_codes_userId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_mfa_recovery_codes_code"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_webauthn_credentials_userId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_webauthn_credentials_credentialId"`);
        ...
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP CONSTRAINT "CHK_refresh_tokens_revoked"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "CHK_sessions_expires"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "CHK_sessions_revoked"`);
        await queryRunner.query(`ALTER TABLE "user_devices" DROP CONSTRAINT "UQ_user_device_user_deviceId"`);
        await queryRunner.query(`ALTER TABLE "webauthn_credentials" DROP CONSTRAINT "UQ_webauthn_user_credential"`);
        await queryRunner.query(`ALTER TABLE "user_devices" DROP COLUMN "deviceName"`);
        await queryRunner.query(`ALTER TABLE "user_devices" DROP COLUMN "lastUsedAt"`);
        await queryRunner.query(`ALTER TABLE "user_devices" ALTER COLUMN "deviceId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_devices" ALTER COLUMN "lastLogin" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_devices" ALTER COLUMN "trusted" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "logs" ALTER COLUMN "details" SET DEFAULT '{}'`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "phoneVerificationToken"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "phoneVerificationToken" character varying(255)`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_93d50353ef8c9b9b1ca2421a17" ON "refresh_tokens" ("isRevoked") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_08a22e1217e17aea515cd7ab4a" ON "sessions" ("revoked") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e6f17432bf91510411c796ef78" ON "mfa_recovery_codes" ("code") `);
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "CHK_cae46de039467f3011904a5191" CHECK ("expiresAt" > "createdAt")`);
        await queryRunner.query(`ALTER TABLE "webauthn_credentials" ADD CONSTRAINT "UQ_c5be2da517dc03e3fff87040bf0" UNIQUE ("userId", "credentialId")`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD CONSTRAINT "FK_610102b60fea1455310ccd299de" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD CONSTRAINT "FK_b25a58a00578bd1b7a01623d2dd" FOREIGN KEY ("sessionId") REFERENCES "sessions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "mfa_recovery_codes" ADD CONSTRAINT "FK_1aeec4efb39bc7c382cbce99948" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "webauthn_credentials" ADD CONSTRAINT "FK_4e5d1a5131f49fdbc410b8ded04" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "webauthn_credentials" DROP CONSTRAINT "FK_4e5d1a5131f49fdbc410b8ded04"`);
        ...
        await queryRunner.query(`ALTER TABLE "webauthn_credentials" DROP CONSTRAINT "UQ_c5be2da517dc03e3fff87040bf0"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "CHK_cae46de039467f3011904a5191"`);
        await queryRunner.query(`ALTER TABLE "sessions" DROP CONSTRAINT "CHK_28e3764c2f42fae67c1e20bcc5"`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP CONSTRAINT "CHK_b2902f12bf1a3f5e6d32e97eb3"`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP CONSTRAINT "CHK_6d668d5831681657a7029ee87a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7dfa5b36a9305efc5b7e9f369a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c1d63ed5127c053e50abcdbce5"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_682897ba764db30ef8836c9b74"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_807abb1f01d751e24c2a5fda8e"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e6f17432bf91510411c796ef78"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_08a22e1217e17aea515cd7ab4a"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_93d50353ef8c9b9b1ca2421a17"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "phoneVerificationToken"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "phoneVerificationToken" character varying`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "emailVerificationToken"`);
        await queryRunner.query(`ALTER TABLE "users" ADD "emailVerificationToken" character varying`);
        await queryRunner.query(`ALTER TABLE "logs" ALTER COLUMN "details" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "user_devices" ALTER COLUMN "trusted" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_devices" ALTER COLUMN "lastLogin" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_devices" ALTER COLUMN "deviceId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_devices" ADD "lastUsedAt" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "user_devices" ADD "deviceName" character varying`);
        await queryRunner.query(`ALTER TABLE "webauthn_credentials" ADD CONSTRAINT "UQ_webauthn_user_credential" UNIQUE ("userId", "credentialId")`);
        await queryRunner.query(`ALTER TABLE "user_devices" ADD CONSTRAINT "UQ_user_device_user_deviceId" UNIQUE ("userId", "deviceId")`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "CHK_sessions_revoked" CHECK (((revoked = false) OR ((revoked = true) AND ("revokedAt" IS NOT NULL))))`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "CHK_sessions_expires" CHECK (("expiresAt" > "createdAt"))`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD CONSTRAINT "CHK_refresh_tokens_revoked" CHECK ((("isRevoked" = false) OR (("isRevoked" = true) AND ("revokedAt" IS NOT NULL))))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_logs_tenantId" ON "logs" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_logs_userId" ON "logs" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_webauthn_credentials_credentialId" ON "webauthn_credentials" ("credentialId") `);
        await queryRunner.query(`CREATE INDEX "IDX_webauthn_credentials_userId" ON "webauthn_credentials" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_mfa_recovery_codes_code" ON "mfa_recovery_codes" ("code") `);
        await queryRunner.query(`CREATE INDEX "IDX_mfa_recovery_codes_userId" ON "mfa_recovery_codes" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_user_devices_deviceId" ON "user_devices" ("deviceId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_api_keys_tenantId" ON "api_keys" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_api_keys_userId" ON "api_keys" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_sessions_revoked" ON "sessions" ("revoked") `);
        ...
        await queryRunner.query(`ALTER TABLE "logs" ADD CONSTRAINT "FK_logs_user" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "webauthn_credentials" ADD CONSTRAINT "FK_webauthn_credentials_user" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "mfa_recovery_codes" ADD CONSTRAINT "FK_mfa_recovery_codes_user" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_devices" ADD CONSTRAINT "FK_user_devices_user" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "api_keys" ADD CONSTRAINT "FK_api_keys_tenant" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "api_keys" ADD CONSTRAINT "FK_api_keys_user" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "sessions_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD CONSTRAINT "refresh_tokens_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "sessions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
...
exports.AddOtpColumnsToUsers1748058940861 = AddOtpColumnsToUsers1748058940861;
//# sourceMappingURL=1748058940861-AddOtpColumnsToUsers.js.map