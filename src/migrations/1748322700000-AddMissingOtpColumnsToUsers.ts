...
export class AddMissingOtpColumnsToUsers1748322700000
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN IF EXISTS "accountRecoveryTokenExpiry"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN IF EXISTS "accountRecoveryToken"`,
    );
    await queryRunner.query(
