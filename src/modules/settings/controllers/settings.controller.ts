...
export class SettingsController {
  ...
  async create(
    ...
    return this.settingsService.setValue(
      ...
      (createSettingDto.type as SettingType),
  ...
  async update(
    ...
    return this.settingsService.setValue(
      ...
      (updateSettingDto.type as SettingType),
  ...
  async getSessionSettings(): Promise<SessionSettingsDto> {
  ...
  async getTokenSettings(): Promise<TokenSettingsDto> {
    return this.settingsService.getTokenSettings();
  }

  @Get('categories/profile')
  @Roles('admin')
  @ApiOperation({ summary: 'Get profile update settings.' })
  @ApiOkResponse({
    type: ProfileSettingsDto,
    description: 'Profile update settings.',
  })
  async getProfileSettings(): Promise<ProfileSettingsDto> {
  ...
  async upsertBulkSettings(
    ...
    return this.settingsService.upsertBulkSettings(
      settings.map(s => ({
        ...s,
