// DTOs for Tenants
 ...
 export class CreateTenantDto {
   ...
   @ApiPropertyOptional({ example: 'https://cdn.example.com/logo.png', description: 'Logo URL' })
   @IsOptional()
   @IsString()
   logo?: string;
   ...
   @ApiPropertyOptional({ type: 'object', example: { timezone: 'UTC' }, description: 'Tenant settings', additionalProperties: true })
   @IsOptional()
